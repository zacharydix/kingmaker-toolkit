      ...
      callback: async (html) => {
        ...
        switch (degree) {
          case 3:
            ...
            result = "You recruit the army.";
            break;

          case 2:
            outcome = "Success";
            result = `
              You recruit the army, but gain 1 Unrest.<br>
          ...
          case 1:
            outcome = "Failure";
            result = `
              You fail to recruit the army, and gain 1 Unrest.<br>
              <button class="kingdom-adjust-unrest" data-amount="1">+1 Unrest</button>
            `;
            break;
          ...
          case 0:
            ...
            result = `
              You fail to recruit the army, and gain 2 Unrest.<br>
        ...
        await ChatMessage.create({
          ...
          content: `
            <div style="line-height:1.25;">
              <strong>Recruit an Army</strong><br>
