      ...
      callback: async (html) => {
        ...
        switch (degree) {
          case 3:
            ...
            result = "You build roads in the targeted hexes, plus one additional road in a contiguous hex.";
            break;

          case 2:
            outcome = "Success";
            result = "You build roads in the targeted hexes.";
            break;
