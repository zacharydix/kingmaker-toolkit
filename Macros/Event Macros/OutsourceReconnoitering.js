...
new Dialog({
  title: "Outsource Reconnoitering",
  content: `
    <form>
  ...
  case 3:
    ...
    result = `
      You gather accurate intelligence. The GM answers your question
      truthfully and either provides additional information or context,
      or answers one follow-up question about the next encounter.
    `;
    break;
  ...
  case 2:
    ...
    result = `
      You gather accurate intelligence. The GM answers your question
      truthfully about the next encounter.
    `;
    break;
        ...
        await ChatMessage.create({
          ...
          content: `
            <div style="line-height:1.25;">
              <strong>Outsource Reconnoitering</strong><br>
