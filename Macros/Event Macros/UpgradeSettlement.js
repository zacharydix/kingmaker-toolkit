      ...
      callback: async (html) => {
        ...
        switch (degree) {
          case 3:
            ...
            result = "You upgrade the settlement and it gains 2 Foci.";
            break;

          case 2:
            outcome = "Success";
            result = "You upgrade the settlement and it gains 1 Focus.";
            break;
        ...
        await ChatMessage.create({
          ...
          content: `
            <div style="line-height:1.25;">
              <strong>Upgrade a Settlement</strong><br>
