      ...
      callback: async (html) => {
        ...
        switch (degree) {
          case 3:
            ...
            result = "The army learns the tactic.";
            break;

          case 2:
            outcome = "Success";
            result = `
              The army learns the tactic, but you gain 1 Unrest.<br>
          ...
          case 1:
            outcome = "Failure";
            result = `
              The army fails to learn the tactic, and you gain 1 Unrest.<br>
              <button class="kingdom-adjust-unrest" data-amount="1">+1 Unrest</button>
            `;
            break;
          ...
          case 0:
            ...
            result = `
              The army fails to learn the tactic, and you gain 2 Unrest.<br>
        ...
        await ChatMessage.create({
          ...
          content: `
            <div style="line-height:1.25;">
              <strong>Train an Army</strong><br>
