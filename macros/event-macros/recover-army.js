      ...
      callback: async (html) => {
        ...
        switch (degree) {
          case 3:
            ...
            result = "Your army recovers 1 hit point or loses a negative condition.";
            break;

          case 2:
            outcome = "Success";
            result = `
              Your army recovers 1 hit point or loses a negative condition, but you gain 1 Unrest.<br>
          ...
          case 1:
            outcome = "Failure";
            result = `
              Your army does not recover, and you gain 1 Unrest.<br>
              <button class="kingdom-adjust-unrest" data-amount="1">+1 Unrest</button>
            `;
            break;
          ...
          case 0:
            ...
            result = `
              Your army does not recover, and you gain 2 Unrest.<br>
