      ...
      callback: async (html) => {
        ...
        switch (degree) {
          case 3:
            ...
            result = "You add the hexes to your kingdom’s borders, plus one additional contiguous hex.";
            break;

          case 2:
            outcome = "Success";
            result = "You add the hexes to your kingdom’s borders.";
            break;
